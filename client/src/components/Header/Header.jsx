  ...
  return (
    <div className="relative mx-auto mb-6 flex h-12 items-center justify-end border-b-2 border-zinc-600/30 bg-[url('/images/background/waveBanner-1.webp')] bg-cover bg-center bg-no-repeat dark:bg-zinc-800">
      ...
      >
        ...
        <div className="absolute left-0 top-12 w-full origin-top-right scale-y-0 bg-zinc-800 py-2 transition-transform peer-open:z-30 peer-open:flex peer-open:origin-top-right peer-open:scale-y-100 peer-open:flex-col peer-open:items-center peer-open:justify-center">
